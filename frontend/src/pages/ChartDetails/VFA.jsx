...
const VFADetails = () => {
  ...
  return (
    <div>
      <NavigationBar />
      <h2 className="my-4">VFA Details</h2>
      <Container fluid>
        <br />
        <Row className="mb-3">
        ...
        <Row className="my-3">
          ...
          <Col md={12} className="d-flex justify-content-end">
            ...
            />
            <Button className="mx-3 " variant="secondary">Search</Button>
          </Col>
        ...
        <Row className="align-items-center">
          <Col md={12} className="d-flex justify-content-end">
            ...
            <Button variant="danger" className="mx-2">Hight VFA</Button>
            <Button variant="secondary" className="mx-2">Min</Button>
            <Button variant="secondary" className="mx-2">Max</Button>
          </Col>
            <InputGroup
